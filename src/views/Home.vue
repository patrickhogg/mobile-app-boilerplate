<template>
  <div class="p-6">
    <div class="mb-8">
      ...
      <p class="text-slate-500 mt-2">Welcome to your modern Capacitor app.</p>
    </div>

    <!-- Feature Card -->
    <div class="bg-white rounded-2xl shadow-sm p-6 mb-6 border border-slate-100">
      <div class="h-12 w-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4">
      ...
      <h2 class="text-xl font-semibold text-slate-900">Fast & Native</h2>
      <p class="text-slate-600 mt-2 text-sm leading-relaxed">
        Built with Vue 3, Vite, and Tailwind CSS. Wrapped by Capacitor for native performance.
      </p>
    </div>
    ...
    <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
      ...
      <div class="flex items-center space-x-2">
        ...
        <span class="text-indigo-100 text-sm font-medium">Online</span>
      </div>
    </div>
  </div>
</template>
